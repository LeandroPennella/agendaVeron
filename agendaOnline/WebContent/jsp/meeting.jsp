			...
			<div style="width: 350px" class="panel panel-primary">
				...
				<div class="panel-body">
					<form:form commandName="formMeeting"
						action='${pageContext.request.contextPath}/saveMeeting.htm'
						method="POST">
						<!--nombre -->
						...
						<div class="form-group">
							...
							<form:input class="form-control" path="theme" />
						</div>
						<!--fecha del evento -->
						<div class="form-group">
						...
						<div align="center">
							...
							<a class="btn btn-primary" href='<c:url value="/calendar.htm" />'><fmt:message
								key="label.cancel" /></a>
						</div>
					</form:form>
				</div>
