				...
				<div style="width: 350px" class="panel panel-primary">
					...
					<div class="panel-body">
						<form:form commandName="formPrivateEvent" action='${pageContext.request.contextPath}/savePrivateEvent.htm' method="POST">
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										...
										<form:select class="form-control" id="startTimepicker" path="startTime">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										...
										<form:select class="form-control" id="endTimepicker" path="endTime">
											<form:options items="${hours}"/>
										</form:select>
									</div>	
								</div>
							...
							<div align="center">
								<form:button class="btn btn-primary" ><fmt:message key="label.save"/></form:button>
								<a class="btn btn-primary" href='<c:url value="/calendar.htm" />'><fmt:message key="label.cancel"/></a>
							</div>
						</form:form>
					</div>
				</div>
